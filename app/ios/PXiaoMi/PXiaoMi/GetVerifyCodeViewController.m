...
- (IBAction)btnGetVerifyCode:(id)sender {
...
- (IBAction)btnConfirm:(id)sender {
    ...
    [manager POST:@"http://172.16.1.132:6188/v1/password/verify"
       parameters:@{@"mobile" : self.tf_phoneNumber.text,
          ...
          success:^(AFHTTPRequestOperation *operation, id responseObject) {
              ...
              switch ([status intValue]) {
                  case 0:{
                      RetrievePasswordViewController *next = [[RetrievePasswordViewController alloc] init];
                      next = [self.storyboard instantiateViewControllerWithIdentifier:@"RetrievePasswordViewController"];
